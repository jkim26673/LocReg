...
#         table.scale(1.2, 2.5)
#         table_ax.set_title('Wing Problem No Feedback Table', fontsize=16, fontweight='bold', y=1.2)  # Adjust the y position
...
#         table.set_fontsize(12)
#         table.scale(1.2, 2.5)
#         table_ax.set_title('Wing Problem with Feedback Table', fontsize=16, fontweight='bold', y=1.2)  # Adjust the y position
#         plt.tight_layout()
#         string = "Wing"
#         file_path = create_result_folder(string, SNR)
...
# date = datetime.now().strftime("%Y%m%d")
# np.savetxt(f'/Users/steveh/Downloads/NIH 23-24/LocReg_Python/Experiments/classical_problems/Testing_Ito_{date}_wing.csv', vecs , delimiter=',')
...
np.savetxt('wing_vec.csv', vecs , delimiter=',')
np.savetxt('wing_noise_arr_1000', noise_arr)
...
plt.savefig(f'wing_prob_nrun_{nrun}_{name}.png')  # You can specify the desired filename and format
...
plt.savefig(f'wing_prob_nrun{nrun}_09_11_23.png')  # You can specify the desired filename and format
plt.show()
"""