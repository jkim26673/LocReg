...
# # sys.path.append("C:\Users\kimjosy\AppData\Local\miniconda3\envs\locreg")
# import numpy as np
# import os
# import pickle
...
if np.any(g) < 0:
    ...
    print("deriv2 is non-neg problem")
...
#         #     if np.any(lambdasfeed[i]) < 1e-10 or np.any(lambdas[i]) < 1e-10:
#         #         reconstfeed[i] = 0  # Set corresponding reconstruction index to 0
#         #         reconst[i] = 0
#         #         print("replaced bad lambdas")
#         #     else:
#         #         print("no unreasonable lambdas")
#         #         pass
...
#         table.scale(1.2, 2.5)
#         table_ax.set_title('Deriv2 Problem No Feedback Table', fontsize=16, fontweight='bold', y=1.2)  # Adjust the y position
...
#         table.set_fontsize(12)
#         table.scale(1.2, 2.5)
#         table_ax.set_title('Deriv2 Problem with Feedback Table', fontsize=16, fontweight='bold', y=1.2)  # Adjust the y position
#         plt.tight_layout()
#         string = "Deriv2"
#         file_path = create_result_folder(string, SNR)
...
# date = datetime.now().strftime("%Y%m%d")
# np.savetxt(f'/Users/steveh/Downloads/NIH 23-24/LocReg_Python/Experiments/classical_problems/Testing_Ito_{date}_deriv2.csv', vecs , delimiter=',')
