...
if np.any(g) < 0:
    ...
    print("gravity is non-neg problem")
...
#         table.scale(1.2, 2.5)
#         table_ax.set_title('Gravity Problem No Feedback Table', fontsize=16, fontweight='bold', y=1.2)  # Adjust the y position
...
#         table.set_fontsize(12)
#         table.scale(1.2, 2.5)
#         table_ax.set_title('Gravity Problem with Feedback Table', fontsize=16, fontweight='bold', y=1.2)  # Adjust the y position
#         plt.tight_layout()
#         string = "Gravity"
#         file_path = create_result_folder(string, SNR)
...
# print("Median Ito Derivative No Feedback:", np.median(com_vec_ItoLR))
# print("Median Ito No Derivative No Feedback:", np.median(com_vec_ItoLR2))
# print("Median Ito Gamma: No Feedback", np.median(com_vec_ItoLR3))
# print("Median Ito Derivative Gamma: No Feedback", np.median(com_vec_ItoLR4))
...
# date = datetime.now().strftime("%Y%m%d")
# np.savetxt(f'/Users/steveh/Downloads/NIH 23-24/LocReg_Python/Experiments/classical_problems/Testing_Ito_{date}_gravity.csv', vecs , delimiter=',')
...
# conventional_plus_oracle = np.asarray([com_vec_DP, com_vec_LC, com_vec_GCV, com_vec_oracle])
# Ito_nofeed = np.asarray([com_vec_ItoLR, com_vec_ItoLR2, com_vec_ItoLR3, com_vec_ItoLR4])
# Ito_feed = np.asarray([com_vec_ItoLR_feed, com_vec_ItoLR2_feed, com_vec_ItoLR3_feed, com_vec_ItoLR4_feed])

# hprParams = {
#     "L2NormErrors": conventional_plus_oracle,
#     "L2NormErrorsItoNoFeed": Ito_nofeed,
#     "L2NormErrorsItoFeed": Ito_feed,
#     'n_noise_realizations': nrun,
#     "noise_vec":noise_vec,
#     'eps1': eps1,
#     "ep_min": ep_min,
#     "eps_cut": eps_cut,
